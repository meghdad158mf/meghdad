"""
روزی دو بار (هر ۱۲ ساعت) Edge Function «news-insights» رو صدا می‌زنه تا
تحلیل هوش مصنوعی «اخبار منتخب» + «موضوعات ترند» تب «آنالیز» به‌روز بشه.
...
با این روش دقیقاً ۲ بار در روز (نه هر بار که یه مدیر/بیننده تب رو باز
...
(۱۲ ساعت) — یعنی هر اجرا دقیقاً بازه‌ای رو پوشش می‌ده که از اجرای قبلی
تا الان طول کشیده.
